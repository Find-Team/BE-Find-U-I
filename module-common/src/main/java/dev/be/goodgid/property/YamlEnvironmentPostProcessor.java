package dev.be.goodgid.property;

import static dev.be.goodgid.constant.Constant.BETA;
import static dev.be.goodgid.constant.Constant.LOCAL;
import static dev.be.goodgid.constant.Constant.REAL;
